...
return (
    ...
    <div className="ques_createForm">
        <div>
            <h3 className="ques_createTitle">문제 추가</h3>
            <div>
                <form className="ques_form" onSubmit={saveQuestion} encType="multipart/form-data">
...
export default CreateQuesComponent;